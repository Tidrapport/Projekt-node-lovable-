...
export default defineConfig({
  server: {
    ...
    proxy: {
      ...
      "/plan-settings": { target: "http://localhost:3000", changeOrigin: true },
      "/plan-change-requests": { target: "http://localhost:3000", changeOrigin: true },
      "/certificates": { target: "http://localhost:3000", changeOrigin: true },
      ...
      "/deviation-reports": { target: "http://localhost:3000", changeOrigin: true },
      "/deviation_reports": { target: "http://localhost:3000", changeOrigin: true },
